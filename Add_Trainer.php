...
<div class="Add_Client_Div px-5 mx-5 py-5 ">
  <form class="Add_Client px-5 py-4 ml-5 bg-light" action="action/Add_Trainer.php" method="post">
  <div class="form-group">
    <label>Trainer ID</label>
    <input type="number" class="form-control" placeholder="ID" name="trainerid">
  </div>
  <div class="form-group">
    <label>Name</label>
  ...
  <button type="submit" class="btn btn-warning mt-3" name="submit">Add Trainer</button>
</form>
</div>
</div> 
</body>
