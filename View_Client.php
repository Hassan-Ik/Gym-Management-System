...
?>
<a href="Add_Client.php"><button class="btn btn-warning my-3 float-left">Add Clients</button></a>
...
<?php 
    ...
    <tr>
      ...
      <?php echo "<td><a href=action/Delete.php?id=".$data['id'].">Delete</a></td>"; ?>
      <?php echo "<td><a href=action/Update.php?id=".$data['id'].">Edit</a></td>"; ?>
