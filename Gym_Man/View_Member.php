...
<div class="row bg-light py-2">
  <div class="col-sm-12">
      <h5>Gym MemberShip Plans</h5>
  </div>
</div>
<?php
$connection = new mysqli('localhost','root','','clients');

$selectQuery=$connection->query("SELECT * FROM `Packages`"); 
  
?>
<div class="row">
  <div class="col-sm-12 text-center"><a href="Add_Member.php"><button class="btn btn-warning my-3 float-left">Add Membership Plan</button></a>
</div>
</div>
<div class="row">
...
<?php 
    ...
    <div class="card-body">
      ...
      <p>Duration: <?=$data['Package_duration']?></p>
      <p>Gym Timming: 6am to 9am ,6pm to 11pm</p>
      <h5>Gym Fee: <?=$data['Package_Fee']?> Rs</h5>
      <h5>Admission Fee: 2000 Rs</h5>
    </div> 
        </div>
      </div>
