...
<div class="row py-2 bg-light">
  <div class="col-sm-12">
    <h5>Membership Packages Management</h5>
  </div>
</div>
<div class="Add_Client_Div px-5 mx-5 py-5 ">
  <form class="Add_Client px-5 py-4 ml-5 bg-light" action="action/Add_Member.php" method="post">
  <div class="form-group">
    <label>Package Name</label>
    <input type="text" class="form-control" placeholder="Any Name" name="packagename">
  </div>
  <div class="form-group">
    <label>Package Duration</label>
    <h6>From</h6><input type="date" class="form-control" name="Packagestart">
    <h6>to</h6><input type="date" class="form-control" name="Packageend">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Any thing,spa,beauty parlour,free cafeteria." name="offers">
  </div>
  <button type="submit" class="btn btn-warning mt-3" name="submit">Add Membership Plan</button>
</form>
</div>
</div> 
</body>
